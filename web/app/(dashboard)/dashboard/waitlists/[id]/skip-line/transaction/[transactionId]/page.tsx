              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between items-center p-4 bg-muted rounded-lg">
                    ...
                    <span className="text-xl font-bold text-foreground">
                      {payment.currency === "USD" ? "-$" : "-"}{payment.providerFee.toFixed(2)}
                    </span>
                  </div>
                  ...
                  <div className="flex justify-between items-center p-4 bg-muted rounded-lg">
                    ...
                    <span className="text-xl font-bold text-foreground">
                      {payment.currency === "USD" ? "-$" : "-"}{payment.platformFee.toFixed(2)}
                    </span>
                  </div>
                  ...
                  <div className="flex justify-between items-center p-4 bg-success/10 border border-success/20 rounded-lg">
                    ...
                    <span className="text-2xl font-bold text-success">
                      {payment.currency === "USD" ? "$" : ""}{payment.founderAmount.toFixed(2)}
                    </span>
                  </div>
                </div>
              </CardContent>
